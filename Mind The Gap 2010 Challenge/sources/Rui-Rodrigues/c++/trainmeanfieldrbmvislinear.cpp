     ...
     /* trainmeanfieldrbmvislinear.cpp - train rbmvislinear in a deterministic way 
...
const double epsilonweights=0.02;

const double epsilonbias=0.02;
...
void meanfieldtrainrbmvislinear(unsigned numepochs,gsl_vector *vectorweightsandbias,
...
if(argc<3){
    ...
    cout<<" must be called with argument signal1 and folder name. Optionaly thereis an extra argument: useblacklist !"<<endl;
 ...
 //computer error rate before training
  ...
  meanfieldtrainrbmvislinear(numepochs,vectorweightsandbias,data,ninputs,nhidden);
