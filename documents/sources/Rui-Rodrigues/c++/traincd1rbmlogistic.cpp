     ...
     /* traincd1rbmlogistic.cpp - train rbmlogistic in cd-1 way (random zero one output in the hidden layer)
...
void cd1trainrbmlogistic(unsigned numepochs,gsl_vector *vectorweightsandbias,
...
if(argc<4){
 ...
 //computer error rate before training
  ...
  cd1trainrbmlogistic(numepochs,vectorweightsandbias,data,ninputs,nhidden);
